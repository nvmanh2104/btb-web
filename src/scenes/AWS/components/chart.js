...
//   }
 ...
 class DetailRainChart extends React.PureComponent {
 ...
 <LineChart
  ...
  >
    ...
    {/* <XAxis dataKey="DateTime"   height={20}
          ...
          //  angle={30} dx={20}
           /> */}
    <YAxis interval="preserveStartEnd" unit="mm"   />
...
//const DetailRainChart =({detailRainData}) => (
  ...
  DetailRainChart.propTypes = {
    detailRainData:  PropTypes.array.isRequired,

}

DetailRainChart.defaultProps = {
    detailRainData: [],

}


export default WithLoading(DetailRainChart)